...
final class SelectItemCell: RadioButtonCell {
    ...
    private var item = DishItem(title: "", imagePath: "", description: "", weight: 0, kcal: 0, price: 0)
